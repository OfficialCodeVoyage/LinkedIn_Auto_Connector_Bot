...
void new CLI({
    ...
    pinnedBrowsers: {
        [Browser.CHROME]: puppeteer.configuration.browserRevision ||
            PUPPETEER_REVISIONS['chrome'] ||
            'latest',
        [Browser.FIREFOX]: puppeteer.configuration.browserRevision ||
            PUPPETEER_REVISIONS['firefox'] ||
            'latest',
        [Browser.CHROMEHEADLESSSHELL]: puppeteer.configuration.browserRevision ||
